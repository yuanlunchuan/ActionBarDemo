...
//@interface androidiosActionBarObject : NSObject
//@end

@interface androidiosActionBarObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[androidiosActionBarObject class]])
		{
			for (NSString *key in [[(androidiosActionBarObject*)o modules] allKeys])
			{
