...
@interface androidiosActionBarObject : KrollCoverageObject {
#else
@interface androidiosActionBarObject : KrollObject {
#endif
@private
...
extern NSString * androidiosActionBar$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	androidiosActionBarObject *_androidiosactionbar;
    KrollObject* console;
	BOOL shutdown;
