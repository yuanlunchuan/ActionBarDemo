 ...
 * to send analytic data that can be viewed on the androidiosActionBar Dashboard.
 *
 * For information on getting started with androidiosActionBar Platform Services,
