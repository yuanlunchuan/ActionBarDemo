...
/**
 Base class for all androidiosActionBar views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the androidiosActionBar view hierarchy (such as wrapped iOS UIViews) was touched.
