...
// in simulator we redefine to format for androidiosActionBar Developer console
...
{\
	NSString * exceptionName = [@"org.androidiosactionbar." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.androidiosactionbar";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIandroidiosActionBarNativeItemNone = -1, 
	UIandroidiosActionBarNativeItemSpinner = -2,
	UIandroidiosActionBarNativeItemProgressBar = -3,
	
	UIandroidiosActionBarNativeItemSlider = -4,
	UIandroidiosActionBarNativeItemSwitch = -5,
	UIandroidiosActionBarNativeItemMultiButton = -6,
	UIandroidiosActionBarNativeItemSegmented = -7,
	
	UIandroidiosActionBarNativeItemTextView = -8,
	UIandroidiosActionBarNativeItemTextField = -9,
	UIandroidiosActionBarNativeItemSearchBar = -10,
	
	UIandroidiosActionBarNativeItemPicker = -11,
	UIandroidiosActionBarNativeItemDatePicker = -12,
	
	UIandroidiosActionBarNativeItemInfoLight = -13,
	UIandroidiosActionBarNativeItemInfoDark = -14,
	
	UIandroidiosActionBarNativeItemDisclosure = -15,
	
	UIandroidiosActionBarNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all androidiosActionBar instances of
